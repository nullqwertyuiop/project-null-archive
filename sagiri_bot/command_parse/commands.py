...
class Prostitute(BooleanCommand):
    __name__ = "prostitute"
    level = 3


class SignInReward(BooleanCommand):
    __name__ = "sign_in"
    level = 3


class Notice(BooleanCommand):
    __name__ = "notice"
    level = 2


class SearchHelper(BooleanCommand):
    __name__ = "search_helper"
    level = 2


class RandomHusband(BooleanCommand):
    __name__ = "random_husband"
    level = 2


class TenHusband(BooleanCommand):
    __name__ = "ten_husband"
    level = 2


class GachaSimulator(BooleanCommand):
    __name__ = "gacha_simulator"
    level = 2


class BilibiliAppParse(BooleanCommand):
    __name__ = "bilibili_app_parse"
    level = 2


class Trusted(BooleanCommand):
    __name__ = "trusted"
    level = 4
