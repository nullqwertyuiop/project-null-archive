...
async def status_presenter_handler(app: Ariadne, message: MessageChain, group: Group, member: Member):
...
class StatusPresenterHandler(AbstractHandler):
    ...
    async def handle(app: Ariadne, message: MessageChain, group: Group, member: Member):
        ...
        #         Normal()
        #     )
        #if message_text == "/help" or message_text == "!help" or message_text == ":help":
        #    return MessageItem(
        #        MessageChain.create([Plain(text='发送 "使用文档" 以获得更加详细的使用帮助。')]),
        #        QuoteSource()
        #    )
        ...
        #     if index > length:
        #         return MessageItem(MessageChain.create([Plain(text="非法编号！请检查发送的信息！")]), QuoteSource())
        #     else:
        #         content = "Handler详情：\n"
