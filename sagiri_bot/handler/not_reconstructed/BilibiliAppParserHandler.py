...
# from SAGIRIBOT.utils import sec_format, get_setting, MessageChainUtils
...
#                 try:
#                     return MessageItem(await BilibiliAppParserHandler.generate_messagechain(result), Normal())
#                 except Exception:
#                     return MessageItem(MessageChain.create([Plain(text=f"解析失败，请联系机器人管理员。")]), Normal())
#
#             else:
#                 return None
#         else:
